...
extern int xF, yF;
extern std::string tellPlayer;
int fire;
extern bool endGame;


void Board::initializeGrid() {																													//Function adds a space to each array coordinate to make the board square
	for (int n = 0; n < 10; n++) {
		for (int m = 0; m < 10; m++) {
			board[n][m] = " ";
		}
...
void Board::createBattleGrid() {																												//When called this function will display the players board with a break between each cell of the array
...
void Board::fireCoord() {													//Function used for validating that the user input a number between 0 and 9 for the board to fire at 
	do {
